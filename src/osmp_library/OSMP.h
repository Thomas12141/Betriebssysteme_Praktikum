...
/**
 * Falls eine Funktion noch nicht implementiert ist, geben diese OSMP_NOT_IMPLEMENTED_YET zurück.
 */
...
/**
 * Die Funktion prüft, ob die mit der Request verknüpfte, nicht blockierende Operation abgeschlossen ist.
